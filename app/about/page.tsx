...
export default function About() {
    return (
        <main className="bg-gradient-to-b from-surface-muted to-surface min-h-screen">
            ...
            <section className="py-24 relative overflow-hidden bg-gradient-to-b from-surface-muted to-surface">
                    ...
                    >
                        {values.map((value, i) => (
                            <motion.div
                                ...
                                className="text-center p-10 rounded-card bg-surface shadow-xl hover:shadow-2xl hover:shadow-accent/20 transition-all duration-500 border border-accent/10"
                            >
                                <div className="mx-auto mb-8 p-6 rounded-pill bg-accent/10 w-fit shadow-md">
                                    <value.icon size={48} className="text-accent" />
                                </div>
                                <h3 className="text-2xl font-semibold mb-4 text-text-heading">{value.title}</h3>
                                <p className="text-text-primary text-lg leading-relaxed">{value.desc}</p>
                            </motion.div>
                        ))}
                    </motion.div>
                </div>
